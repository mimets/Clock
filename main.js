...
ALTER TABLE ss_rooms ENABLE ROW LEVEL SECURITY;
ALTER TABLE ss_signals ENABLE ROW LEVEL SECURITY;
...
DROP POLICY IF EXISTS "anon_all" ON typing_status;
DROP POLICY IF EXISTS "anon_all" ON chat_groups;
DROP POLICY IF EXISTS "anon_all" ON group_members;
DROP POLICY IF EXISTS "anon_all" ON ss_rooms;
DROP POLICY IF EXISTS "anon_all" ON ss_signals;
...
CREATE POLICY "anon_all" ON ss_rooms FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "anon_all" ON ss_signals FOR ALL USING (true) WITH CHECK (true);
`.trim();
