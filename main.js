...
ALTER TABLE messages ADD COLUMN IF NOT EXISTS pinned boolean default false; (id bigint generated by default as identity primary key, created_at timestamp with time zone default now(), message_id text not null, username text not null);
...
CREATE TABLE IF NOT EXISTS ss_rooms (id TEXT PRIMARY KEY, broadcaster TEXT NOT NULL, active BOOLEAN DEFAULT TRUE, created_at TIMESTAMPTZ DEFAULT NOW());
CREATE TABLE IF NOT EXISTS ss_signals (id BIGSERIAL PRIMARY KEY, room_id TEXT NOT NULL, sender TEXT NOT NULL, type TEXT NOT NULL, data TEXT NOT NULL, created_at TIMESTAMPTZ DEFAULT NOW());
DO $$ BEGIN ALTER TABLE users ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE configs ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE leaderboard ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE message_reactions ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE messages ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE message_likes ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE follows ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE notifications ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE calendar_events ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE typing_status ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE chat_groups ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE group_members ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ss_rooms ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ss_signals ENABLE ROW LEVEL SECURITY; EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON message_reactions; CREATE POLICY "anon_all" ON message_reactions FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON messages; CREATE POLICY "anon_all" ON messages FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON message_likes; CREATE POLICY "anon_all" ON message_likes FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON follows; CREATE POLICY "anon_all" ON follows FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON notifications; CREATE POLICY "anon_all" ON notifications FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON calendar_events; CREATE POLICY "anon_all" ON calendar_events FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON typing_status; CREATE POLICY "anon_all" ON typing_status FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON chat_groups; CREATE POLICY "anon_all" ON chat_groups FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON group_members; CREATE POLICY "anon_all" ON group_members FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON ss_rooms; CREATE POLICY "anon_all" ON ss_rooms FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN DROP POLICY IF EXISTS "anon_all" ON ss_signals; CREATE POLICY "anon_all" ON ss_signals FOR ALL USING (true) WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_insert_users" ON users FOR INSERT TO anon WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_select_users" ON users FOR SELECT TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_update_users" ON users FOR UPDATE TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_insert_configs" ON configs FOR INSERT TO anon WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_select_configs" ON configs FOR SELECT TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_update_configs" ON configs FOR UPDATE TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_insert_leaderboard" ON leaderboard FOR INSERT TO anon WITH CHECK (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_select_leaderboard" ON leaderboard FOR SELECT TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_update_leaderboard" ON leaderboard FOR UPDATE TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_delete_users" ON users FOR DELETE TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_delete_configs" ON configs FOR DELETE TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "anon_delete_leaderboard" ON leaderboard FOR DELETE TO anon USING (true); EXCEPTION WHEN undefined_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
